        ...
        <section class="p-10 flex flex-col gap-5">
            ...
            <div class="flex flex-row">
                <div class="lg:flex p-5 w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <iframe class="lg:w-1/3 w-full" src="{{ $video->link }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
                    </iframe>
                    <div class="p-5 lg:w-1/2 w-full">
                        ...
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"> {{$video->desc}} </p>
